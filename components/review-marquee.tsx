		...
		<section className="py-20 overflow-hidden bg-gradient-to-br from-brand-cream via-white to-brand-mint/20">
			<div className="mx-auto max-w-6xl px-4 mb-12">
				<div className="text-center space-y-4">
					<h2 className="text-4xl font-bold bg-gradient-to-r from-brand-navy via-brand-teal to-brand-sage bg-clip-text text-transparent">Apa Kata Pelanggan Kami</h2>
